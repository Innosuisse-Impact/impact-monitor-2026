...
Innosuisse funding is used to support more complex and higher-risk projects, as well as interdisciplinary projects. Interdisciplinary projects integrate knowledge, methods and technologies from different disciplines to jointly develop novel solutions to complex problems. Transdisciplinary projects also actively involve non-academic stakeholders from society, politics, business and practice in the research process in order to jointly solve socially relevant problems and generate practical knowledge. The 23% share of radical innovation projects indicates the degree of risk involved in innovation projects. 
